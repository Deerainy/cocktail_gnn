...
class RecipeComboAdjustResult(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['recipe_id', 'snapshot_id']),
            models.Index(fields=['recipe_id', 'target_canonical_id']),
            models.Index(fields=['recipe_id', 'accept_flag']),
...
class RecipeComboAdjustStep(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['plan_id', 'step_no']),
        ]
